    ...
    return(
        <div className=" mt-[150px] w-full gap-4 mb-8" id="contact">
            <div className="grid sm:grid-cols-2 p-4">
                <div className="w-[350px] md:w-[350px] mt-8 text-center justify-center">
                ...
                <form className="block mt-4 overflow-hidden">
                    ...
                    <button 
                        ...
                        className="bg-[#DCF2F1] w-full mt-4 px-4 rounded-md font-medium my-4 mx-auto py-2 text-[#0F1035] hover:shadow-md hover:shadow-blue-700 transition delay-150 duration-300 ease-in-out hover:scale-105">
                        Send
                    </button>
                </form>
            </div>
